...
(function($) {
  ...
  $.fn.media.defaults.players = {
    ...
    quicktime: {
      ...
      types:
        "aif,aiff,aac,au,gsm,mov,mid,midi,mpg,mpeg,m4a,psd,qt,qtif,qif,qti,snd,tif,tiff,wav,3g2,3gp",
      ieAttrs: {
  ...
  function generate(el, opts, player) {
    ...
    } else if (player == "html5video") {
      a = ['<video width="' + opts.width + '" height="' + opts.height + '" '];
      for (key in opts.attrs) {
        a.push(key + " ");
      }
      a.push('><source src="' + opts.src + '" type="' + o.mimetype + '">');
      a.push("</video>");
    } else if (player == "img") {
      o = $("<img>");
      o.attr("src", opts.src);
